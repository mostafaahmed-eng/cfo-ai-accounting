...
def upgrade() -> None:
    user_status_enum = postgresql.ENUM(
        "active", "invited", "disabled", name="userstatus", create_type=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "fiscal_year_start", sa.SmallInteger, nullable=False, server_default="1"
        ),
        sa.Column("timezone", sa.String(50), nullable=False, server_default="UTC"),
    ...
    op.create_table(
        ...
        sa.Column(
            "is_payment_account", sa.Boolean, nullable=False, server_default="false"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "detected_language", sa.String(10), nullable=False, server_default="unknown"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "document_type", sa.String(20), nullable=False, server_default="other"
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column("currency", sa.String(3), nullable=False),
        sa.Column(
            "exchange_rate", sa.Numeric(18, 8), nullable=False, server_default="1"
        ),
        sa.Column(
            "posted_by",
            postgresql.UUID(as_uuid=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "alert_percentage", sa.Numeric(5, 2), nullable=False, server_default="80"
        ),
        sa.Column(
            "created_at", sa.DateTime, nullable=False, server_default=sa.func.now()
        ),
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "company_id", "base_currency", "quote_currency", "rate_date"
        ),
    )
