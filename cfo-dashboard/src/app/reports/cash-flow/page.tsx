            ...
            <div className="bg-white rounded-lg shadow p-6 max-w-2xl">
              ...
              <div className="space-y-4">
                <div className="flex justify-between text-sm py-2 border-b">
                  ...
                  <span className="font-medium">${cashFlow.operating.toLocaleString()}</span>
                </div>
                <div className="flex justify-between text-sm py-2 border-b">
                  <span>Investing Activities</span>
                  <span className="font-medium">${cashFlow.investing.toLocaleString()}</span>
                </div>
                <div className="flex justify-between text-sm py-2 border-b">
                  <span>Financing Activities</span>
                  <span className="font-medium">${cashFlow.financing.toLocaleString()}</span>
                </div>
